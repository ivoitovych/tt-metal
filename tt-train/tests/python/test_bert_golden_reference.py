...
def test_bert_qkv_loading_golden_reference(model_name, batch_size, seq_len):
    ...
    input_ids_ttml = ttml.autograd.Tensor.from_numpy(input_ids_np.reshape(batch_size, 1, seq_len, 1))
    token_type_ids_ttml = ttml.autograd.Tensor.from_numpy(token_type_ids_np.reshape(batch_size, 1, seq_len, 1))
