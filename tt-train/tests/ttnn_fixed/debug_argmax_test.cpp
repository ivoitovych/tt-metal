...
// Debug test to isolate untilize/argmax issue on Blackhole
// Run with: ./tt-train/build/tests/ttml_tests --gtest_filter="DebugArgmaxTest.*"
...
class DebugArgmaxTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(DebugArgmaxTest, ArgmaxAligned64) {
...
TEST_F(DebugArgmaxTest, ArgmaxUnaligned65) {
    auto* device = &ttml::autograd::ctx().get_device();
...
TEST_F(DebugArgmaxTest, ArgmaxUnaligned65NoUntilize) {
    auto* device = &ttml::autograd::ctx().get_device();
...
TEST_F(DebugArgmaxTest, SubtractMaskThenArgmax65) {
    auto* device = &ttml::autograd::ctx().get_device();
...
TEST_F(DebugArgmaxTest, RandomWithMask65) {
    auto* device = &ttml::autograd::ctx().get_device();
...
TEST_F(DebugArgmaxTest, ArgmaxUnaligned33) {
    auto* device = &ttml::autograd::ctx().get_device();
...
TEST_F(DebugArgmaxTest, UntilizeOnly64) {
    auto* device = &ttml::autograd::ctx().get_device();
...
TEST_F(DebugArgmaxTest, UntilizeOnly33) {
    auto* device = &ttml::autograd::ctx().get_device();
...
TEST_F(DebugArgmaxTest, InspectUntilizeOutput65) {
    auto* device = &ttml::autograd::ctx().get_device();
